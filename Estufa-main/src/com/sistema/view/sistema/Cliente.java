package com.sistema.view.sistema;
...
public class Cliente extends com.sistema.Cliente {
    private String nome;
    private String cpf;
    ...
    private ArrayList<com.sistema.Higrometro> higrometro;
    ...
    public ArrayList<com.sistema.Higrometro> getHigrometroList() {
        return this.higrometro;
    }
