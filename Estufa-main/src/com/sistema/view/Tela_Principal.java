...
private void configurarCoresCabecalhosTabelas() {
    ...
    private void initComponents() {
        ...
        listPlantio.setFont(new Font("Menlo", 1, 18)); // NOI18N
        ...
        btnAdiciomar.setBackground(new Color(204, 255, 204));
        btnAdiciomar.setFont(new Font("Menlo", 1, 18)); // NOI18N
        ...
        btnRemover.setBackground(new Color(204, 255, 204));
        btnRemover.setFont(new Font("Menlo", 1, 18)); // NOI18N
        btnRemover.setText("-");
        ...
        btnHistorico.setFont(new Font("Menlo", 1, 18)); // NOI18N
        ...
        lblPlantio.setFont(new Font("Menlo", 1, 18)); // NOI18N
        lblPlantio.setText("PLANTIOS");

        lblTemperatura.setFont(new Font("Menlo", 1, 18)); // NOI18N
        lblTemperatura.setText("TEMPERATURA");

        lblUmidade.setFont(new Font("Menlo", 1, 18)); // NOI18N
        lblUmidade.setText("UMIDADE");

        lblIrrigacao.setFont(new Font("Menlo", 1, 18)); // NOI18N
        lblIrrigacao.setText("IRRIGAÇÃO");

        lblAlertas.setFont(new Font("Menlo", 1, 18)); // NOI18N
