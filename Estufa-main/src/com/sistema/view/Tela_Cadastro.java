...
public class Tela_Cadastro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtNome.setBackground(new Color(206, 228, 250));
        txtNome.setOpaque(true);

        txtEmail.setBackground(new Color(206, 228, 250));
        ...
        txtCelular.setBackground(new Color(206, 228, 250));
        try {
        ...
        txtData_Nasc.setBackground(new Color(206, 228, 250));
        try {
        ...
        txtSenha.setBackground(new Color(206, 228, 250));
        txtSenha.setText("jPasswordField1");
        txtSenha.setOpaque(true);

        txtCpf.setBackground(new Color(206, 228, 250));
        try {
